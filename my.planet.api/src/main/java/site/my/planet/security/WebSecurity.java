...
public class WebSecurity extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable().authorizeHttpRequests()
                ...
                .antMatchers(HttpMethod.GET, "/media/project/{id}").permitAll()
                ...
                .antMatchers(HttpMethod.GET, "/project/user/{id}").permitAll()
                .antMatchers(HttpMethod.GET, "/project/img/{imgName}").permitAll()
                .antMatchers(HttpMethod.POST, "/project").hasAnyAuthority("u", "a")
                .antMatchers(HttpMethod.PUT, "/project/{id}").hasAnyAuthority("u", "a")
                .antMatchers(HttpMethod.DELETE, "/project/{id}").hasAnyAuthority("u", "a")
                //
